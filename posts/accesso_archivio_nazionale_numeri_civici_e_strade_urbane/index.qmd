...
::: {.callout-note}
## L'associazione onData ha creato l'archivio di questi dati

In [questo *repository* su GitHub](https://github.com/ondata/archivio_anncsu), è presente l'archivio di tutte le strade e tutti gli indirizzi di Italia. Alla date del 11 febbraio 2025, moltissimi dei civici non hanno coordinate geografiche associate.
:::
