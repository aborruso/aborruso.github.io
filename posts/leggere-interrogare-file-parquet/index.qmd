...
::: {.callout-note}
Nella versione di Observable gratuita e *online*, il limite delle dimensioni di un file è di 50 MB. Ma utilizzando [Observable Framework](https://observablehq.com/framework/) o con [Quarto](https://quarto.org/docs/computations/ojs.html), le dimensioni dei file non sono un problema.
:::
