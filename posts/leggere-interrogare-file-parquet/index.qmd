...
Si tratta dei catalogo dei **progetti** ed è disponibile qui: ................
...
**`SQL`** è uno dei linguaggi più diffusi e standard per l'interrogazione e la manipolazione dei dati. È **nato 50 anni fa**, quindi ci sono un'enormità di libri, *tutorial*, corsi, forum, *cheatsheet*, ecc. per imparare a usarlo, e ci sono centinaia di applicazioni, librerie, *framework*, ecc. per usarlo.
