...
- prima si trasformano le colonne `longitudine` e `latitudine` in un punto con `ST_POINT(longitudine, latitudine)`;
- poi si verifica se il punto è all'interno del poligono `bergamo.geom` con `ST_Within()`.
:::
