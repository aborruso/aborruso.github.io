...
Risolve un [*bug*](https://github.com/duckdb/duckdb/discussions/13295#discussioncomment-10251603) che non consentiva di utilizzare pienamente il comodissimo parametro `decimal_separator`. Sino alla versione precedente infatti, se io impostavo `decimal_separator = ','`, DuckDB non era in grado di inferire correttamente i tipi campo `FLOAT` e li considerava sempre delle stringhe.<br>
...
Prima in modo un po' più macchinoso era necessario definire sia il separatore decimale che il tipo di campo, adesso basta il primo.<br>
