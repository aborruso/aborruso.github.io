...
```bash
mlr --csv --ifs ";" cut -f Missione,"Codice Univoco Misura","CUP Codice Natura" then \
...
: *Output* di Miller {.striped .responsive}
...
Il formato CSV **non è uno standard**, ma una convenzione non ufficiale che è stata ampiamente adotatta e descritta nella [RFC 4180](https://tools.ietf.org/html/rfc4180).
:::
