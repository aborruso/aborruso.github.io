...
Pubblica già dati in formato `parquet`, sono disponibili gli URL statici dei file, ed è possibile fare *query* in modo comodissimo, come se fossero [disponibili delle API](#come-avere-delle-api).<br>
