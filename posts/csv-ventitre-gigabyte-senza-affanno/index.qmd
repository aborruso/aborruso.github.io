...
Quella che ci sembra critica è relativa alla **natura dei progetti**, che era la novità più importante: sul `CSV` **ci sono soltanto 3 tipologie**, quindi nulla è cambiato. Le altre tipologie al momento sono visibili soltanto sul *front-end* del sito.<br>
Sottolineiamo inoltre come i **dati** **PNRR** **non** sembra siano stati **aggiornati**, così come non è presente un attributo nel file complessivo che contraddistingua i progetti PNRR.
<br>Abbiamo chiesto spiegazioni a OpenCUP e appena avremo risposte aggiorneremo questo post.
:::
