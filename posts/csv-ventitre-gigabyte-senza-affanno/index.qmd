...
Un'altra che ci sembra più importante è quella sul **numero dei progetti**: sul sito sono indicati circa 9.5 milioni, ma nel file `CSV` ce ne sono soltanto 6.5 milioni.<br>
E sottolineiamo come i **dati** **PNRR** **non** sembra siano stati **aggiornati**, così come non è presente un attributo nel file complessivo che contraddistingua i progetti PNRR.
